...
public class SequentialObjectInputStream extends DataInputStream implements ObjectInput
{
    ...
    public Object[] readObject() throws ClassNotFoundException, IOException
    {
        ...
        System.out.println("readObject : " + Long.toString(Total) + " objects in graph");
        ...
        for (int I=0; I < Total; I++)
        {
            ...
            System.out.println("Object of "+C.getCanonicalName() +" on graph");
            ...
            if (C.isArray())
            {
                ...
                System.out.println("array of "+ComponentType.getCanonicalName() + ", " + Long.toString(Size) + " elements");          
